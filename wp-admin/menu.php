...
# LHG: changed so that everybody can see the comment overview page
$menu[25] = array( sprintf( __('Comments %s'), "<span class='awaiting-mod count-$awaiting_mod'><span class='pending-count'>" . number_format_i18n($awaiting_mod) . "</span></span>" ), 'read', 'edit-comments.php', '', 'menu-top menu-icon-comments', 'menu-comments', 'div' );

$current_user = wp_get_current_user();

# LHG: changed so that everybody can see the comment overview page
if ($current_user->ID != 1) $menu[25] = array( sprintf( __('Comments %s'), "<span class='awaiting-mod count-$awaiting_mod'><span class='pending-count'>" . number_format_i18n($awaiting_mod) . "</span></span>" ), 'read', 'edit-comments.php?comment_status=approved', '', 'menu-top menu-icon-comments', 'menu-comments', 'div' );

unset($awaiting_mod);

# LHG: changed so that everybody can see the comment overview page
$submenu[ 'edit-comments.php' ][0] = array( __('All Comments'), 'read', 'edit-comments.php' );
