...
function wp_one_post_admin_scripts() {
  ...
  wp_register_style( 'wp-one-post-admin', plugins_url('css/lhg_widget_article_summary_admin.css'));
  wp_enqueue_style( 'wp-one-post-admin' );
}    
add_action('admin_enqueue_scripts', 'wp_one_post_admin_scripts');

function wp_one_post_scripts() {
  wp_register_style( 'wp-one-post-widget', plugins_url('css/lhg_widget_article_summary.css'));
