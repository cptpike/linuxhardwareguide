			...
			echo "<!-- Wordpress Popular Posts Plugin v". $this->version ." [W] [".$instance['range']."] [".$instance['order_by']."]". (($instance['markup']['custom_html']) ? ' [custom]' : ' [regular]') ." -->"."\n";
                        ...
                        if ($lang == "de") {
                	        ...
                	        $content2 .='<li><a href="/linux-hardware-guide-team" title="Diskussion mit dem LHG-Team"><div class="popular-post">
                                                ...
                                                <b>Allgemeine Diskussion mit dem LHG-Team</b>:
                        	...
                        	$content2 .='<li><a href="/linux-hardware-diskussionen" title="Allgemeine Linux Hardware-Diskussionen"><div class="popular-post">
                                                ...
                                                <b>Linux Hardware - Hilfe und Artikel-Anfragen</b>:
                                                <span class="wpp-excerpt">
			...
			if ( !is_array($mostpopular) || empty($mostpopular) ) { // no posts to show
				...
				foreach($mostpopular as $p) {
					...
					if ( $instance['stats_tag']['comment_count'] ) {
						...
						_n('1 new comment', '%s new comments', $comments, 'wordpress-popular-posts'),
					...
					if (1==1) {
						...
						$tbWidth = 40; //$instance['thumbnail']['width'];
						$tbHeight = 40; //$instance['thumbnail']['height'];
						...
						/*
							...
							$thumb .= $this->get_img( $p->id, array($tbWidth, $tbHeight), $this->user_ops['tools']['thumbnail']['source'] );
                                                ...
                                                */
                                                ...
                                                $p->id,
                                                array(40,40),
                                                array('class' => 'wp-cpl-sc-thumb', 'alt' => translate_title(get_the_title($p->id)), 'title' => translate_title(get_the_title($p->id)))
                                                );
