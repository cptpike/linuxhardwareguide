...
class WP_Widget_Categories extends WP_Widget {
	...
	function widget( $args, $instance ) {
		...
		echo $before_widget;
		if ( $title )
                echo $before_title . '<i class="icon-folder-open"></i> '. $title . $after_title;
...
?>
		...
		<?php if ( $title ) echo $before_title . '<i class="icon-plus"></i> '. $title . $after_title; ?>
		...
		<?php
                ...
                if ($catid == 238) continue;

                $title=get_the_title();
                $pos = strpos($title,"(Deutsch)");


                if($pos === false) {
                        $art_image=get_the_post_thumbnail( $post_id, array(24,24) );
                        //echo "AI: <pre>$art_image</pre>";
                        //if ($art_image == "" ) echo "not found";
                        if ($art_image == "" ) $art_image = '<img src="http://www.linux-hardware-guide.com/wp-uploads/2013/03/noimage130.jpg" height="24" width="24" />';
			echo '
   <li class="recentcomments">
      <div class="widgetimg_all">
         ...
         <div class="widgetimg_text">
           <a href="';
        	        echo get_permalink();
                	echo '" title="'. translate_title($title) .'">'. translate_title($title) .'
           </a>
          ...
          <div class="widgetimg_all">
            <div class="widgetimg_avatar">';
              		        ...
              		        $output_tmp .=
                                ...
                                $output_tmp_1.'
              <img src="' . $avatarurl .'" height="24" width="24" alt="Avatar" />'.
              			$output_tmp_2;
        ...
        ';
					...
					$output_lang .= $output_tmp;
	                	        $comment_found++;
                                        ...
                                        //echo "B";
                                        if ($comment_default_found < 5) $output_default .= $output_tmp;
	                	        $comment_default_found++;
	       			}
			}

                        if ($output_lang == "") $output .= $output_default;
                        if ($output_lang != "") $output .= $output_lang;
